...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "Lu Huiguo" => "luhuiguo@gmail.com", "other author" => "email@address.com" }
  # s.author       = 'Lu Huiguo', 'other author'
  ...
  s.source       = { :git => "https://github.com/luhuiguo/ffmpeg-ios.git"}
  ...
  s.libraries = 'avcodec','avformat', 'avutil' ,'swscale', 'avdevice' ,'avfilter','swresample'
